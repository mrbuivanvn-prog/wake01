...
window.createManualCard = async function() {
    ...
    const pron  = document.getElementById('newPronunciation')?.value.trim();
    ...
    try {
        ...
        if (res.ok) {
            ...
            if(document.getElementById('newPronunciation')) document.getElementById('newPronunciation').value = '';
